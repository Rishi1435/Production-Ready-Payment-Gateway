...
function Docs() {
  return (
    <div style={{ padding: '20px', maxWidth: '800px' }} data-testid="api-docs">
      <h2>Integration Guide</h2>
      <p>Follow these steps to integrate the payment gateway into your website.</p>

      {/* Section 1: Create Order */}
      <section data-testid="section-create-order" style={{ marginBottom: '40px' }}>
        ...
        <div style={{ background: '#f4f6f8', padding: '15px', borderRadius: '6px', overflowX: 'auto' }}>
          <pre data-testid="code-snippet-create-order" style={{ margin: 0 }}>
{`curl -X POST http://localhost:8000/api/v1/orders \\
  ...
  -d '{
    ...
    "receipt": "receipt_123"
      ...
      <section data-testid="section-sdk-integration" style={{ marginBottom: '40px' }}>
        <h3>2. Frontend SDK Integration</h3>
        <p>Include this script on your checkout page to open the payment modal.</p>
        <div style={{ background: '#f4f6f8', padding: '15px', borderRadius: '6px', overflowX: 'auto' }}>
          <pre data-testid="code-snippet-sdk" style={{ margin: 0 }}>
...
<script>
  ...
  checkout.open();
      ...
      <section data-testid="section-webhook-verification">
        ...
        <div style={{ background: '#f4f6f8', padding: '15px', borderRadius: '6px', overflowX: 'auto' }}>
          <pre data-testid="code-snippet-webhook" style={{ margin: 0 }}>
